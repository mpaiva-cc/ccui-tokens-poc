...
function buildTokensJson(colorEntries, themeLabel, groupName) {
  const paletteObj = {};
...
function main() {
  for (const [themeKey, themeConfig] of Object.entries(THEMES)) {
    ...
    const tokensJson = buildTokensJson(themeConfig.colors, themeLabel, themeConfig.groupName);
